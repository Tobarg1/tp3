...
class ViajeController {
    ...
    public function getAll($req) {
        ...
        $limit = isset($req->query->limit) ? intval($req->query->limit) : null;
        $offset = isset($req->query->offset) ? intval($req->query->offset) : null;

        $viajes = $this->model->obtenerTodosViajes($orderBy, $limit, $offset);
